...
# All ze parameters that are tied to the particular model architecture, we're using for Inception v3. 
# These include things like tensor names and theirsizes. 

MAX_NUM_IMAGES_PER_CLASS = 2 ** 27 - 1  # ~134M

image_path = '../../datasets/color/'
...
def get_image_path(image_lists, label_name, index, image_dir, category):
  ...
  Args:
    ...
    index: Int offset of the image we want. This will be moduloed by the available number of images 
    for the label, so it can be arbitrarily large.
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default='inception_retrained/inception_retrained_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='inception_retrained/intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='inception_retrained/output_labels.txt',
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='inception_retrained/bottleneck',
      help='Path to cache bottleneck layer values as files.'
  )
  parser.add_argument(
      '--final_tensor_name',
      type=str,
      default='final_tensor',
      help="""\
